...
function displayComments(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        commentText.classList.add("comments__comments-cont-def--commentText");
...
document.addEventListener("click", () => {
    nameInput.classList.add("comments__form--name-selected");
    //console.log("Name field has been clicked");
});

const commentsInput = document.querySelector(".comments__form--comment");
console.log(commentsInput);
document.addEventListener("click", () => {
    commentsInput.classList.add("comments__form--comment-selected");
    //console.log("Comment field has been clicked");
});